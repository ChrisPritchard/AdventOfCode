...
- Only consider the digits from the offset onwards: the entire number up to this point can be ignored. This changes a 6.5 million digit number into a ~500k number.
...
- Create a runner that computers the partial sums in reverse. Scanback in F# does this nicely.
