...
::: {.user}
Christopher Pritchard [44\*]{.star-count}
:::
...
   [int y=]{.title-event-wrap}[2023](/2023)[;]{.title-event-wrap} {#int-y2023 .title-event}
=================================================================
...
::: {.sponsor}
[GitButler](https://gitbutler.com/aoc) - Code across multiple branches
at the same time (from the co-founder of GitHub)
:::
:::
:::
...
[Twitter](https://twitter.com/intent/tweet?text=I%27ve+completed+%22Sand+Slabs%22+%2D+Day+22+%2D+Advent+of+Code+2023&url=https%3A%2F%2Fadventofcode%2Ecom%2F2023%2Fday%2F22&related=ericwastl&hashtags=AdventOfCode)
