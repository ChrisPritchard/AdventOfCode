...
::: {.user}
Christopher Pritchard [48\*]{.star-count}
:::
...
   [0x0000\|]{.title-event-wrap}[2023](/2023)[]{.title-event-wrap} {#x00002023 .title-event}
==================================================================
...
::: {.sponsor}
[Zuehlke](https://www.zuehlke.com/en/careers) - Empower ideas and join
our global team of passionate developers.
:::
:::
:::
...
[Twitter](https://twitter.com/intent/tweet?text=I%27ve+completed+%22Never+Tell+Me+The+Odds%22+%2D+Day+24+%2D+Advent+of+Code+2023&url=https%3A%2F%2Fadventofcode%2Ecom%2F2023%2Fday%2F24&related=ericwastl&hashtags=AdventOfCode)
