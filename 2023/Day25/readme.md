...
::: {.user}
Christopher Pritchard [50\*]{.star-count}
:::
...
          []{.title-event-wrap}[2023](/2023)[]{.title-event-wrap} {#section .title-event}
=================================================================
...
::: {.sponsor}
[Optiver](https://optiver.com/advent-of-code) - Ready to solve puzzles
for a living? We're hiring C++, C\# and Python experts to code
sub-nanosecond trading systems. Get ready for problem solving,
continuous learning and the freedom to bring your software solutions to
life
:::
:::
:::
...
[Twitter](https://twitter.com/intent/tweet?text=I%27ve+completed+%22Snowverload%22+%2D+Day+25+%2D+Advent+of+Code+2023&url=https%3A%2F%2Fadventofcode%2Ecom%2F2023%2Fday%2F25&related=ericwastl&hashtags=AdventOfCode)
